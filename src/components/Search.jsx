...
function Search() {
  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      ...
      {/* right side */}
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem] z-[3]">
        {/* Search */}
        ...
        <div className="detail flex flex-col mt-5 text-4xl">
          <span className=" text-[#E600FF]">Search Music by</span>
          <span className=" text-[#E600FF]">
            <b>Name or Direct URL</b>
          </span>
          <span className="text-[20px] mt-3  ">
          Quickly find your favorite tracks, artists, and albums <br />
           with advanced search and smart recommendations <br />
